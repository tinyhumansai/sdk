...
impl<'a> MedullaApi<'a> {
    ...
    async fn body<T: Serialize>(
        ...
        self.http.send(method, path, query, Some(&body), true).await
    }
    pub async fn roster(&self) -> Result<Value, Error> {
        self.http
            .send(Method::GET, "/medulla/v1/roster", &[], None, true)
            .await
    }
    pub async fn routing_strategy(&self) -> Result<Value, Error> {
        self.http
            .send(Method::GET, "/medulla/v1/routing/strategy", &[], None, true)
            .await
    }
    pub async fn set_routing_strategy(&self, strategy: &str) -> Result<Value, Error> {
        self.body(
            Method::PUT,
    ...
    pub async fn create_session(&self, request: &CreateSessionRequest) -> Result<Value, Error> {
        self.body(Method::POST, "/medulla/v1/sessions", &[], request)
            .await
    }
    pub async fn get_session(&self, id: &str) -> Result<Value, Error> {
        self.http
            .send(
                Method::GET,
    ...
    pub async fn delete_session(&self, id: &str) -> Result<Value, Error> {
        self.http
            .send(
                Method::DELETE,
                &format!("/medulla/v1/sessions/{}", enc(id)),
    ...
    pub async fn abort_session(&self, id: &str) -> Result<Value, Error> {
        self.http
            .send(
                Method::POST,
    ...
    pub async fn session_events(&self, id: &str, query: &[QueryParam]) -> Result<Value, Error> {
        self.http
            .send(
                Method::GET,
    ...
    pub async fn session_stream(&self, id: &str, query: &[QueryParam]) -> Result<Value, Error> {
        self.http
            .send(
                Method::GET,
    ...
    pub async fn list_tasks(&self, query: &[QueryParam]) -> Result<Value, Error> {
        self.http
            .send(Method::GET, "/medulla/v1/tasks", query, None, true)
            .await
    }
    pub async fn create_task(&self, request: &CreateTaskRequest) -> Result<Value, Error> {
        self.body(Method::POST, "/medulla/v1/tasks", &[], request)
            .await
    }
    pub async fn update_task(&self, id: &str, request: &UpdateTaskRequest) -> Result<Value, Error> {
        self.body(
            Method::PATCH,
    ...
    pub async fn delete_task(&self, id: &str) -> Result<Value, Error> {
        self.http
            .send(
                Method::DELETE,
                &format!("/medulla/v1/tasks/{}", enc(id)),
    ...
    pub async fn list_task_sources(&self) -> Result<Value, Error> {
        self.http
    ...
    pub async fn delete_task_source(&self, id: &str) -> Result<Value, Error> {
        self.http
            .send(
                Method::DELETE,
    ...
    pub async fn sync_task_source(&self, id: &str) -> Result<Value, Error> {
        self.http
            .send(
                Method::POST,

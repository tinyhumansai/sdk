...
pub const PUBLIC_ROUTES: &[(&str, &str)] = &[
    ...
    (
        "POST",
        "/agent-integrations/twilio/webhooks/incoming-call/{userId}",
    ),
    (
        "POST",
        "/agent-integrations/twilio/webhooks/status/{userId}",
    ),
